Gem::Specification.new do |s|
  ...
  s.files = ["bin/monk", "lib/monk", "lib/monk/config.rb", "lib/monk/file_helpers.rb", "lib/monk/helpers.rb", "lib/monk/init_helpers.rb", "lib/monk/rvm_helpers.rb", "lib/monk.rb", "test/add_test.rb", "test/help_test.rb", "test/init_test.rb", "test/lock_test.rb", "test/mock.rb", "test/test_helper.rb", "test/tmp", "test/tmp/default", "test/tmp/default/init.rb", "test/tmp/default/Monkfile", "test/tmp/x", "test/tmp/x/init.rb", "test/tmp/x/Monkfile", "README.md", "CHANGELOG"]
